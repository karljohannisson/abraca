...
Status: **done**. `.nose/planlint/` landed 2026-09-13. Registry-shaped axes and template `encodes:` bullets: [bugs/planlint-axes-must-be-a-list.md](../bugs/planlint-axes-must-be-a-list.md), [bugs/planlint-ignores-template-encodes.md](../bugs/planlint-ignores-template-encodes.md).
