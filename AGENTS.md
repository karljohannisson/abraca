...
This repo uses the maintainability workflow.

1. Always: [docs/workflow/agent.md](docs/workflow/agent.md)
2. Intent: `product/requirements.md`, `product/axes.yaml`, `product/entry-points.yaml`, `product/probes.md`
